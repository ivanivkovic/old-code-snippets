<?php $this->loadWidget('html_head'); ?>
	...
	<div id="container" style="position: absolute; top: 85px;">
		...
		<div id="profileBox" class="item element" style="height: 100%; cursor: default;">
			<a class="item_link">
				<img alt="" id="profileImage" onload="vAlignMe('#profileImage');" src="<?php echo $this -> registry -> user -> data['profile_pic']?>"/>
			</a>
			...
			<div class="bottom_part">
				...
				<div class="profileBottom">
					...
					<div class="sbutton">
						<a target="_blank" href="<?php echo Conf::$url['facebook'] ?>/<?php echo $this -> registry -> user -> social_id ?>">
					...
					<span><?php echo $this -> registry -> user -> data['fullname'] ?></span>
