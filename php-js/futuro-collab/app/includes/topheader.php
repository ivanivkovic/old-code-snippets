					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="dropdown-submenu">
								<a tabindex="-1" href="/task#userid=<?= Core::$user->id ?>">Moji zadaci</a>
								<ul class="dropdown-menu menu-task-list">
								
									<? foreach($activeTasks as $info): ?>
										<li>
											<a href="/task/<?= $info['taskid'] ?>#subtasks"><?= $info['description'] ?></a>
										</li>
									<? endforeach; ?>
									
									<li class="divider"></li>
									<li class="text-center"><a href="/task#userid=<?= Core::$user->id ?>">Više...</a></li>
								</ul>
							</li>
                        </ul>
					</li>
                            ...
                            <li class="dropdown-submenu">
								...
								<ul class="dropdown-menu">
									<? foreach($activeProjects as $info): ?>
										<li>
											<a href="/project/<?= $info['projectid'] ?>"><?= libString::limitString( $info['title'], 50 ) ?></a>
										</li>
									<? endforeach; ?>
								</ul>
							</li>
	...
	<div class="row-fluid">
		<div class="span12">
			<form class="pull-right">
				<div class="input-prepend" id="global-search">
					<span class="add-on"><i class="icon-search"></i></span>
					<input type="text" name="keyword" placeholder="Klijent, zadatak..." data-lastvalue="" />
				</div>
			</form>
		</div>
	</div><!-- /row -->
