...
class libTemplate
{
	...
	public static function loadTemplateFile($file, $data = array() )
	{
		if( ! empty($data) ){ self::set($data); }
	...
	public static function getFullDateTime( $date )
	{
		return date('d. ', $date) . libDateTime::$months[ self::$lang ][ date('n', $date) ] . date(' Y. h:i', $date);
	}
}
