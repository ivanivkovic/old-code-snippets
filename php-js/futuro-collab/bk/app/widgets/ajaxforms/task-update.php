<form id="task-update" method="POST" class="form" enctype="multipart/form-data">
	...
	<? libTemplate::widget( 'autocomplete', array('limit' => 0, 'name' => 'assigned', 'curvalue' => $autocompleteCurrentValue, 'value' => $autocompleteValues, 'autocompleteList' => $autocompleteList ) ); ?>
	...
	<label for="deadline">Planirano <span class="asterisk">*</a></label>
